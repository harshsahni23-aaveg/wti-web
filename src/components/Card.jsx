    ...
    <div>
      <div className="shadow-md rounded-xl h-auto md:flex md:items-center ">
        ...
        <div className="text-center md:text-left px-4 py-2 md:px-4 h-auto">
          <div className="text-lg md:text-[20px] lg:text-[22px] font-semibold my-2 md:my-2 lg:my-2 lg:leading-8">
      ...
      <div className="text-center md:text-left px-4 lg:px-[1rem] md:h-auto  lg:h-auto py-2">
        ...
        <div className="flex justify-center md:justify-start sm:w-auto h-8">
          <input
            type="text"
            id="email"
            className="px-2.5 lg:max-h-56	 max-h-60	 text-sm text-gray-900 bg-transparent rounded-l-xl md:rounded-l-xl border-2 border-[1px_solid_#D2D2D2] placeholder-[#7A7A7A] md:rounded-none md:border-l-2 md:border-t md:border-b-2 md:border-r-2 lg:border-l-2 lg:rounded-l-xl"
            placeholder="Email address"
          />
          <button
            type="button"
            className="bg-[#0F0A34] hover:bg-[#0F0A34] text-white text-[16px] md:text-[12px] lg:text-[16px] font-normal px-2 rounded-r-xl items-center"
            onClick={onSignMeUp}
          >
            Sign me up
          </button>
